...
| `rocm-7.14-qwen-3.8-flash-next` | ROCm 7.14 (Experimental) | Downloads and applies [llama.cpp PR #27742](https://github.com/ggml-org/llama.cpp/pull/27742) at build time for Qwen3.8-Flash-Next (`qwen4exp`) model support. Manual build only with the `rocm-7.14-qwen-3.8-flash-next` workflow argument. |
